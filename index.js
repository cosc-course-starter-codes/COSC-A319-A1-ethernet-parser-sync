...
module.exports = {
   ...
   * @prop {string} header.destination - a human-readable string representation of the destination MAC address
   ...
   * @prop {number} header.length - the frame payload length without the header or frame check sequence field
   ...
   * @prop {boolean} frame_check_valid - a boolean indicating whether the frame check validation succeeded
   */
